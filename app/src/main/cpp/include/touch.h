...
typedef struct 
{
   ...
   char distinct_id[64+1];         /*用户标示*/
   long datetime;            /**SDK采集时间戳 必有 "2020-03-20 12:23:45.547" **/
   char event_code[64+1];          /**事件code **/
   char original_id[64+1];        /**匿名用户标示**/
...
typedef struct 
{
    ...
    char app_url[256+1]; 
    char app_key[128+1]; 
    char app_secret[128+1]; 
    char app_enable[8+1]; 
    char public_app_name[128+1];            /*项目应用名称*/
    char public_app_version[64+1];         /*项目应用版本*/
